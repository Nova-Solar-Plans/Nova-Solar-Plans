...
import com.user.visitor.VisitorTechnician;
...
public class CustomerCreateRequest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_customer_create_request);
        ...
        ViewTechnicianBackBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(CustomerCreateRequest.this, CustomerViewTechnician.class);
        ...
        CreateReqBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                databaseReference.child(key).child(currentFirebaseUser.getUid()).setValue(requestModal)
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            @Override
                            public void onComplete(@NonNull Task<Void> task) {
                                Toast.makeText(CustomerCreateRequest.this,"Request Submitted",Toast.LENGTH_LONG).show();
                                Intent intent = new Intent(CustomerCreateRequest.this, CustomerDashboard.class);
                                startActivity(intent);
                            }
                        })
                        .addOnFailureListener(new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(CustomerCreateRequest.this,"Request Submitting Failed",Toast.LENGTH_LONG).show();
                            }
                        });
            }
        });
    ...
    public void getTechnicianDetails(){
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Technician").child(key);
            ...
            public void onComplete(@NonNull Task<DataSnapshot> task) {
                ...
                if(task.isSuccessful()){
                    if(task.getResult().exists()){
                        ...
                        Toast.makeText(CustomerCreateRequest.this,"Error fetch data result",Toast.LENGTH_SHORT).show();
                    }
                }
                else{
                    Toast.makeText(CustomerCreateRequest.this,"Error fetch data unsuccessful",Toast.LENGTH_SHORT).show();
                }
